...
<html lang="en">
  ...
  <body>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="id" aria-describedby="idHelp" name="id"
            disabled="disabled" value="{{ $evento->id }}">
  ...
  <div class="mb-3">
    ...
    placeholder="Nombre Evento" value="{{ $evento->nombre }}">
  </div>
  
  <div class="mb-3">
    <label for="descripcion" class="form-label">Descripcion</label>
    <input type="text" class="form-control" id="descripcion" aria-describedby="descripcionHelp" name="descripcion"
    placeholder="Apellido Evento"value="{{ $evento->descripcion }}">
  </div>

  
  <div class="mb-3">
    <label for="fecha_inicio" class="form-label">Fecha Inicio</label>
    <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" value="{{ $evento->fecha_inicio }}">
  </div>

  <div class="mb-3">
    <label for="fecha_fin" class="form-label">Fecha Fin</label>
    <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" value="{{ $evento->fecha_fin }}">
  </div>
  ...
  <div class="mb-3">
    ...
    placeholder="Ubicacion Evento" value="{{ $evento->ubicacion}}">
  </div>
  <div class="mt-3">
